...
class PengajuanMagangController extends Controller
{
    ...
    // Cari dulu apakah email sudah ada
    $pengajuan = PengajuanMagangMahasiswa::where('email_mahasiswa', $request->email_mahasiswa)->first();

    if ($pengajuan) {
        // Update data lama jika sudah ada
        $pengajuan->update([
            ...
            'status'          => 'draft',  // reset status jadi draft lagi
            'is_active'       => true,
            'created_date'    => now(),
        ]);
    } else {
        // Insert baru jika email belum ada
