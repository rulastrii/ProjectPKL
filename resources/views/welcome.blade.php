        ...
        <div class="container py-5">
            ...
            <div class="row g-4">
                @foreach ($syaratMagangItems as $index => $item)
                    @php
                        $icon = data_get($item, 'icon', 'fas fa-circle');
                    ...
                    <div class="col-md-6 wow fadeInUp" data-wow-delay="{{ 0.2 + $index * 0.2 }}s">
                        <div class="feature-item p-4">
                            ...
                            <p class="mb-4">{!! nl2br(e($desc)) !!}</p>

                            @if ($link && $link !== '#')
                                <a class="btn btn-primary rounded-pill py-2 px-4" href="{{ $link }}"
                                    target="_blank">
                                    Detail
                                </a>
                            @endif
    ...
    <div class="container-fluid testimonial pb-5">
        <div class="container pb-5">
            <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style="max-width: 800px;">
                ...
                <p class="mb-0">Berikut adalah pengalaman dan kesan siswa PKL serta mahasiswa magang setelah menyelesaikan
                    program mereka di perusahaan kami.</p>
            </div>
        ...
        <div class="container pb-5">
            <div class="row g-5 align-items-center">
                ...
                <div class="col-xl-7 wow fadeInLeft" data-wow-delay="0.2s">
                    <div>
                        ...
                        <h1 class="display-5 mb-4">
                            {{ $aboutSection['title'] ?? 'Sistem Informasi Pengajuan PKL & Magang DKIS Kota Cirebon' }}
                        </h1>
                        <p class="mb-4">
                            {{ $aboutSection['description'] ?? 'Sistem informasi ini memudahkan siswa/mahasiswa untuk mengajukan permohonan PKL dan magang secara online.' }}
                        </p>

                        <div class="row g-4">
                            @foreach ($aboutSection['features'] as $feature)
                                @php
                                    $icon = data_get($feature, 'icon', 'fas fa-check-circle');
                                    $title = data_get($feature, 'title');
                                    $desc = data_get($feature, 'desc');
                                @endphp
                ...
                <div class="col-xl-5 wow fadeInRight" data-wow-delay="0.2s">
                    <div class="bg-primary rounded d-flex justify-content-center align-items-center position-relative"
                        style="height: 400px;">
                ...
                <div class="col-lg-6 wow fadeInLeft" data-wow-delay="0.2s">
                    <div class="accordion accordion-flush bg-light rounded p-5" id="accordionFlushSection">
                        @foreach ($faqItems as $index => $faq)
                            @php
                                $title = data_get($faq, 'title');
                                $desc = data_get($faq, 'desc');
                            @endphp
