...
@section('content')
  ...
  <div class="row row-cards row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-5 g-3">
    ...
    <div class="col mb-3">
      <div class="card card-sm h-100">
        <div class="card-body d-flex align-items-center">
          <span class="avatar bg-blue text-white me-3 d-flex justify-content-center align-items-center" style="width:48px;height:48px;">
      ...
      <div class="card card-sm h-100">
        <div class="card-body d-flex align-items-center">
          <span class="avatar bg-red text-white me-3 d-flex justify-content-center align-items-center" style="width:48px;height:48px;">
            <i class="ti ti-briefcase" style="font-size:24px;"></i>
          </span>
          <div class="flex-grow-1">
