...
<table width="100%" cellpadding="0" cellspacing="0"
    ...
    <tr>
        <td style="padding:30px; color:#333333; font-size:15px; line-height:1.6;">
            ...
            @if(!empty($password))
                <div style="background:#f8f9fa; border-left:4px solid #206bc4;
            ...
            @else
                <p>
                    Silakan gunakan email dan kata sandi yang Anda buat saat pendaftaran
                    untuk mengakses sistem setelah verifikasi email berhasil.
                </p>
            @endif
            ...
            <p style="font-size:14px; color:#555;">
                Setelah email diverifikasi, akun Anda akan aktif dan dapat digunakan untuk login.
            </p>
