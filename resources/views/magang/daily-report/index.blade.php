@extends('layouts.app')
@section('title','Laporan Harian Magang')
...
<button type="button"
   ...
   class="btn btn-outline-secondary btn-sm">
    Lihat
         ...
         <td class="text-end">
            {{-- Detail --}}
            <a href="{{ route('magang.daily-report.show', $r->id) }}"
...
@include('magang.daily-report.modal-create')
@include('magang.daily-report.modal-edit')
@endsection
